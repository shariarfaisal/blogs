...
- Initial Server Setup with Ubuntu 16.04: Create a sudo user and configure a basic firewall
- How To Install and Configure GitLab on Ubuntu 16.04: Install GitLab on the server and protect it with a Let’s Encrypt TLS/SSL certificate
...
- Initial Server Setup with Ubuntu 16.04: Create a sudo user and configure a basic firewall (you do not have to complete this again if you are setting up the CI runner on the GitLab server)
- How To Install and Use Docker on Ubuntu 16.04: Follow steps 1 and 2 to install Docker on the server
