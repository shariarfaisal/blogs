...
```Ubuntu``` ```Control Panels``` ```Ubuntu 16.04``` ```CentOS```
...
- A domain name pointed at your server. How To Set Up a Host Name with DigitalOcean will show you how to manage a domain with the DigitalOcean control panel. We will use panel.example.com throughout this tutorial
