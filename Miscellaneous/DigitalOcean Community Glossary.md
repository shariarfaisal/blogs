...
```Linux Basics``` ```Miscellaneous``` ```Getting Started```
...
- A complete list of resources on data analysis.
...
- Resources on coding with Python 3, coding with Ruby, and coding with JavaScript.
...
- An introduction to using Django for development.
...
- A complete list of resources on Docker.
...
- A complete list of resources on Drupal.
- A guide to installing Drupal on Ubuntu with Apache.
...
- A complete list of resources on Elasticsearch.
- A guide to installing an ELK Stack on Ubuntu 16.04.
...
- A complete list of resources on Fedora.
...
- An introduction to installing Go 1.6 on Ubuntu 16.04.
...
- An introduction to enabling IPv6 for DigitalOcean Droplets.
...
- An introduction to installing Java on Ubuntu 16.04.
...
- An introduction to writing your first program in JavaScript.
...
- A complete list of resources on Machine Learning.
- An Introduction to Machine Learning.
...
- A complete list of resources on MySQL.
...
- A complete list of resources on Nginx.
- A basic Nginx installation tutorial.
...
- An introduction to installing Node.js on Ubuntu 16.04.
...
- A complete list of resources on Perl.
...
- A complete list of resources related to PHP.
...
- An in-depth overview of how to code in Python 3.
...
- A complete list of Redis-related resources.
...
- A complete list of resources related to Ruby.
...
- A list of resources covering Rails-related topics.
- An introduction to RoR.
...
- Some tips for making your servers more secure.
...
- An introduction to Nginx Server Blocks.
...
- A complete list of resources on Sinatra.
...
- A complete list of Storage-related resources.
...
- An introduction to Apache Virtual Hosts.
...
- A complete list of VPN-related resources.
- How to set up a VPN using OpenVPN.
...
- A complete list of WordPress resources.
