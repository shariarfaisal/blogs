...
```Ubuntu``` ```Ruby``` ```Getting Started``` ```CentOS``` ```Debian```
...
<pre>
rvm <span class=“highlight”>command_options</span> <span class=“highlight”>command</span> <span class=“highlight”>ruby_to_act_on</span>
</pre>
...
<pre>
rvm uninstall <span class=“highlight”>ruby_version</span>
</pre>
